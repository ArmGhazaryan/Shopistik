...
const translations = {
  en: {
    ...
    checkoutIntro: 'Enter your delivery details and place your order.',
    checkoutEmpty: 'Your bag is empty. Add something you love, then return here.',
    ...
    payTransfer: 'Bank Transfer to Card',
    placeOrder: 'Place Order',
    checkoutRequired: 'Please fill in your name and phone number.',
    transferDetailsTitle: 'Transfer details:',
    transferBank: 'Bank: Ameriabank',
    transferAccount: 'Account: 9050000000000000 (IE Anna Ghazaryan)',
    transferNote: 'Please send the receipt or confirmation to our Instagram after the transfer.',
    successEyebrow: 'Order Confirmed',
    successTitle: 'Thank You',
    successMessage: 'Thank you for your order! We will contact you soon to confirm your delivery.',
    each: 'each',
  ...
  hy: {
    ...
    proceedCheckout: 'Անցնել Վճարման',
    cartClose: 'Փակել զամբյուղը',
    checkoutEyebrow: 'Գրեթե Պատրաստ',
    checkoutTitle: 'Պատվերի Հաստատում',
    checkoutIntro: 'Լրացրեք առաքման տվյալները և հաստատեք պատվերը։',
    checkoutEmpty: 'Ձեր զամբյուղը դատարկ է։ Ավելացրեք սիրելի ապրանք, ապա վերադարձեք այստեղ։',
    checkoutDetails: 'Առաքման Տվյալներ',
    ...
    payCash: 'Կանխիկ Առաքման Պահին',
    payTransfer: 'Փոխանցում Քարտին',
    placeOrder: 'Հաստատել Պատվերը',
    checkoutRequired: 'Խնդրում ենք լրացնել անունը և հեռախոսահամարը։',
    transferDetailsTitle: 'Փոխանցման տվյալներ՝',
    transferBank: 'Բանկ՝ Ամերիաբանկ',
    transferAccount: 'Հաշվեհամար՝ 9050000000000000 (ԱՁ Աննա Ղազարյան)',
    transferNote: 'Խնդրում ենք փոխանցումից հետո չեկը կամ հաստատումն ուղարկել մեր Instagram-ին։',
    successEyebrow: 'Պատվերը Հաստատված է',
    successTitle: 'Շնորհակալություն',
    successMessage: 'Շնորհակալություն պատվերի համար։ Մենք շուտով կկապնվենք ձեզ հետ՝ առաքումը հաստատելու համար։',
    each: 'հատը',
  ...
  ru: {
    ...
    checkoutEyebrow: 'Почти готово',
    checkoutTitle: 'Оформление заказа',
    checkoutIntro: 'Укажите данные для доставки и оформите заказ.',
    checkoutEmpty: 'Ваша корзина пуста. Добавьте что-то любимое, затем вернитесь сюда.',
    checkoutDetails: 'Данные для доставки',
    ...
    payTransfer: 'Перевод на карту',
    placeOrder: 'Оформить заказ',
    checkoutRequired: 'Пожалуйста, укажите имя и номер телефона.',
    transferDetailsTitle: 'Данные для перевода:',
    transferBank: 'Банк: Америабанк',
    transferAccount: 'Счёт: 9050000000000000 (ИП Анна Газарян)',
    transferNote: 'Пожалуйста, после перевода отправьте чек или подтверждение в наш Instagram.',
    successEyebrow: 'Заказ подтверждён',
    successTitle: 'Спасибо',
    successMessage: 'Спасибо за ваш заказ! Мы свяжемся с вами в ближайшее время, чтобы подтвердить доставку.',
    each: 'за шт.',
